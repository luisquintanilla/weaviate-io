...
This tutorial demonstrates having Weaviate create vectors with a vectorizer. For a tutorial on using custom vectors, see [this tutorial](/developers/academy/step-2-scenario/custom-vectors).
