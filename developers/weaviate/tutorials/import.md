...
- Set up a `Question` class in your schema.
    - You can follow the Quickstart guide, or the [schema tutorial](../tutorials/schema.md) to construct the Question class if you have not already.
...
As mentioned in the [schema tutorial](../tutorials/schema.md), the `schema` specifies the data structure for Weaviate.
...
- [Tutorial: Schemas in detail](../tutorials/schema.md)
