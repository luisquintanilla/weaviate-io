...
- [How-to: Generative search](/developers/weaviate/search/generative.md)
:::
...
This guide assumes some familiarity with Weaviate, but it is not required. If you are new to Weaviate, we suggest starting with the [Weaviate Quickstart guide](/developers/weaviate/quickstart/index.md).
...
Check the specific documentation for your deployment method ([Docker](/developers/weaviate/installation/docker-compose.md), [Kubernetes](/developers/weaviate/installation/kubernetes.md), [Embedded Weaviate](/developers/weaviate/installation/embedded.md)) for more information on how to configure it.
...
Please see the [documentation](/developers/weaviate/modules/reader-generator-modules/index.md) for the appropriate module for more information on configurable properties.
...
To learn more about specific search capabilities, check out the [How-to: search guide](/developers/weaviate/search/index.md). And to learn more about individual modules, check out the [Modules section](/developers/weaviate/modules/index.md).
