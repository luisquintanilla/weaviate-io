...
<div class="row __academy_cardgroup">
    <div class="col col--6">
        ...
        badgeType="theory"
        buttonURL="/developers/academy/step-1-deployment/which-weaviate"
        />
    </div>
</div>
...
<div class="row __academy_cardgroup">
    <div class="col col--4">
        ...
        buttonType="Click here"
        badgeType="practical"
        buttonURL="/developers/academy/step-2-scenario/text-search"
        />
    </div>
    <div class="col col--4">
        <AcademyCard
        title="Work with your own vectors"
        ...
        buttonType="Click here"
        badgeType="practical"
        buttonURL="/developers/academy/step-2-scenario/custom-vectors"
        />
    </div>
    <div class="col col--4">
        <AcademyCard
        ...
        buttonType="Click here"
        badgeType="practical"
        buttonURL="/developers/academy/step-2-scenario/generative"
        />
    </div>
</div>
